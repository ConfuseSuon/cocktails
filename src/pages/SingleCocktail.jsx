...
const SingleCocktail = () => {
    ...
    try {
      var getCocktail = async ()=>{
        ...
        if(data.drinks){
          ...
          const newCocktail = {name, image, info, category, glass, instructions, ingredient}
  ...
  if(!cocktail){
    return <h2 className='section-title'>no cocktail is to display</h2>
  }

  const {name, image, info, category, glass, instructions, ingredient} = cocktail
